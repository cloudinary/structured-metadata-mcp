 ...
 */
export function metadataFieldsReorderMetadataFields(
  client$: CloudinarySMDCore,
  request: ReorderMetadataFieldsRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ReorderMetadataFieldsRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/v1_1/{cloud_name}/metadata_fields/order")(
    pathParams$,
  );
