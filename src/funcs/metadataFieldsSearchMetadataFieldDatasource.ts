...
import {
  ...
  SearchMetadataFieldDatasourceResponse$zodSchema,
...
> {
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, SearchMetadataFieldDatasourceResponse$zodSchema, {
      key: "ResponseBodies",
    }),
    M.json(401, SearchMetadataFieldDatasourceResponse$zodSchema, {
      key: "api_error",
    }),
